#ifndef PREPROC_DIFF_COLOR_ABS_H_
#define PREPROC_DIFF_COLOR_ABS_H_

#include <cstdint>
#include "i_preproc_handler.hpp"

//Implements IPreprocHandler
class PreprocDiffColorAbs : public IPreprocHandler {
public:
   ...
   PreprocDiffColorAbs(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      overwrite_previous_frame_with_color_diff_abs(current_frame_buf, previous_frame_buf, width, height, bpp, per_color_gate_value);
   ...
   const char* get_name() override {
      return "Diff Color Abs";
   }
};

#endif /* PREPROC_DIFF_COLOR_ABS_H_ */