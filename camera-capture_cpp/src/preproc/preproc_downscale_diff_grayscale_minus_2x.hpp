#ifndef PREPROC_DOWNSCALE_DIFF_GRAYSCALE_MINUS_2X_H_
#define PREPROC_DOWNSCALE_DIFF_GRAYSCALE_MINUS_2X_H_

#include <cstdint>
#include "i_preproc_handler.hpp"

//Implements IPreprocHandler
class PreprocDownscaleDiffGrayscaleMinus2x : public IPreprocHandler {
public:
   ...
   PreprocDownscaleDiffGrayscaleMinus2x(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      downscale_grayscale_image(previous_grayscale_buf, previous_grayscale_buf, width, height, 2);
   ...
   void init() override {
      ...
      downscale_grayscale_image(second_grayscale_buf, second_grayscale_buf, width, height, 2);
   }
    
   const char* get_name() override {
      return "Downscale Diff Grayscale Minus 2x";
   }
};

#endif /* PREPROC_DOWNSCALE_DIFF_GRAYSCALE_MINUS_2X_H_ */