#ifndef PREPROC_LEFT_SOBEL_H_
#define PREPROC_LEFT_SOBEL_H_
...
class PreprocLeftSobel : public IPreprocHandler {
public:
    PreprocLeftSobel(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      calculate_left_sobel(grayscale_buf, second_grayscale_buf, width, height);
