#ifndef PREPROC_DIFF_GRAYSCALE2_H_
#define PREPROC_DIFF_GRAYSCALE2_H_

#include <cstdint>
#include "i_preproc_handler.hpp"

//Implements IPreprocHandler
class PreprocDiffGrayscale2 : public IPreprocHandler {
public:
   ...
   PreprocDiffGrayscale2(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      overwrite_previous_grayscale_with_diff2(current_grayscale_buf, previous_grayscale_buf, width, height, gate_value);
   ...
   const char* get_name() override {
      return "Diff Grayscale2";
   }
};

#endif /* PREPROC_DIFF_GRAYSCALE2_H_ */