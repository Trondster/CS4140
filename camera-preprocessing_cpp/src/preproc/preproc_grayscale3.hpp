#ifndef PREPROC_GRAYSCALE3_H_
#define PREPROC_GRAYSCALE3_H_
...
class PreprocGrayscale3 : public IPreprocHandler {
public:
    PreprocGrayscale3(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
