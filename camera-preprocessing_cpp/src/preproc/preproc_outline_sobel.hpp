#ifndef PREPROC_OUTLINE_SOBEL_H_
#define PREPROC_OUTLINE_SOBEL_H_
...
class PreprocOutlineSobel : public IPreprocHandler {
public:
    PreprocOutlineSobel(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      calculate_outline(grayscale_buf, second_grayscale_buf, width, height);
...
#endif /* PREPROC_OUTLINE_SOBEL_H_ */