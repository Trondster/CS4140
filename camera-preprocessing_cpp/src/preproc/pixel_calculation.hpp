...
void overwrite_previous_grayscale_with_diff(const uint8_t* current_padded_grayscale_buf, uint8_t* previous_padded_grayscale_buf,
...
void overwrite_previous_grayscale_with_diff2(const uint8_t* current_padded_grayscale_buf, uint8_t* previous_padded_grayscale_buf,
   const int width, const int height, const int gate_value) {
   int buf_img_w = width + 2;
   for (int y = 0; y < height; y++) {
      for (int x = 0; x < width; x++) {
