#ifndef PREPROC_DIFF_GRAYSCALE_H_
#define PREPROC_DIFF_GRAYSCALE_H_

#include <cstdint>
#include "i_preproc_handler.hpp"

//Implements IPreprocHandler
class PreprocDiffGrayscale : public IPreprocHandler {
public:
   ...
   PreprocDiffGrayscale(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      overwrite_previous_grayscale_with_diff(current_grayscale_buf, previous_grayscale_buf, width, height, gate_value);
   ...
   const char* get_name() override {
      return "Diff Grayscale";
   }
};

#endif /* PREPROC_DIFF_GRAYSCALE_H_ */