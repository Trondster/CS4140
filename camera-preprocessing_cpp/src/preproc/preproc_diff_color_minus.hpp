#ifndef PREPROC_DIFF_COLOR_MINUS_H_
#define PREPROC_DIFF_COLOR_MINUS_H_

#include <cstdint>
#include "i_preproc_handler.hpp"

//Implements IPreprocHandler
class PreprocDiffColorMinus : public IPreprocHandler {
public:
   ...
   PreprocDiffColorMinus(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      overwrite_previous_frame_with_color_diff_minus(current_frame_buf, previous_frame_buf, width, height, bpp, per_color_gate_value);
   ...
   const char* get_name() override {
      return "Diff Color Minus";
   }
};

#endif /* PREPROC_DIFF_COLOR_MINUS_H_ */