#ifndef PREPROC_DOWNSCALE_GRAYSCALE_2X_H_
#define PREPROC_DOWNSCALE_GRAYSCALE_2X_H_
...
class PreprocDownscaleGrayscale2x : public IPreprocHandler {
public:
    PreprocDownscaleGrayscale2x(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      downscale_grayscale_image(grayscale_buf, second_grayscale_buf, width, height, 2);
...
#endif /* PREPROC_DOWNSCALE_GRAYSCALE_2X_H_ */