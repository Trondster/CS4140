#ifndef PREPROC_DOWNSCALE_DIFF_GRAYSCALE_MINUS_4X_H_
#define PREPROC_DOWNSCALE_DIFF_GRAYSCALE_MINUS_4X_H_

#include <cstdint>
#include "i_preproc_handler.hpp"

//Implements IPreprocHandler
class PreprocDownscaleDiffGrayscaleMinus4x : public IPreprocHandler {
public:
   ...
   PreprocDownscaleDiffGrayscaleMinus4x(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      downscale_grayscale_image(previous_grayscale_buf, previous_grayscale_buf, width, height, 4);
...
#endif /* PREPROC_DOWNSCALE_DIFF_GRAYSCALE_MINUS_4X_H_ */