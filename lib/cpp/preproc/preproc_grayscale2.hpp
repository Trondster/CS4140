#ifndef PREPROC_GRAYSCALE2_H_
#define PREPROC_GRAYSCALE2_H_
...
class PreprocGrayscale2 : public IPreprocHandler {
public:
    PreprocGrayscale2(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
