#ifndef PREPROC_DOWNSCALE_GRAYSCALE_4X_H_
#define PREPROC_DOWNSCALE_GRAYSCALE_4X_H_
...
class PreprocDownscaleGrayscale4x : public IPreprocHandler {
public:
    PreprocDownscaleGrayscale4x(uint8_t* input_buf, uint8_t* second_buf, uint8_t* grayscale_buf, uint8_t* second_grayscale_buf,
   ...
   void process() override {
      ...
      downscale_grayscale_image(grayscale_buf, second_grayscale_buf, width, height, 4);
   ...
   const char* get_name() override {
      return "Downscale Grayscale 4x";
   }
};

#endif /* PREPROC_DOWNSCALE_GRAYSCALE_4X_H_ */